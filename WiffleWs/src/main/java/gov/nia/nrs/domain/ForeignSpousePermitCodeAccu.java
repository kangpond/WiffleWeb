...
/**
 * ForeignSpousePermitCodeAccu
 */
@Entity
@Table(name="ForeignSpousePermitCodeAccu"
)
public class ForeignSpousePermitCodeAccu  implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    private ForeignSpousePermitCodeAccuId id;
    private Integer spCount;
    private String maintainProgramId;
    private String maintainHost;
    private Date lastUpdateTime;

    public ForeignSpousePermitCodeAccu() {}

	
    public ForeignSpousePermitCodeAccu(ForeignSpousePermitCodeAccuId id, Integer spCount) {
        this.id = id;
        this.spCount = spCount;
    }
    public ForeignSpousePermitCodeAccu(ForeignSpousePermitCodeAccuId id, Integer spCount, String maintainProgramId, String maintainHost, Date lastUpdateTime) {
        this.id = id;
        this.spCount = spCount;
    ...
    @AttributeOverrides( {
        ...
        @AttributeOverride(name="permitNoCode", column=@Column(name="PermitNoCode", nullable=false, length=4) ), 
        @AttributeOverride(name="reason", column=@Column(name="Reason", nullable=false, precision=4, scale=0) ) } )
    public ForeignSpousePermitCodeAccuId getId() {
        return this.id;
    }
    
    public void setId(ForeignSpousePermitCodeAccuId id) {
        this.id = id;
    }
