...
/**
 * NoMatchEntryExit generated by hbm2java
 */
@Entity
@Table(name="NoMatchEntryExit"
)
public class NoMatchEntryExit  implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    private NoMatchEntryExitId id;
    ...
    public NoMatchEntryExit() {}

	
    public NoMatchEntryExit(NoMatchEntryExitId id, String gender, Integer birthPlaceCode, Integer birthPlace1, String chineseName, String birthDate, String flightNo, String deleteFlag, String mainUserId, String maintainProgramId, String maintainHost, Date lastUpdateTime) {
        this.id = id;
        this.gender = gender;
    ...
    public NoMatchEntryExitId getId() {
        return this.id;
    }
    
    public void setId(NoMatchEntryExitId id) {
        this.id = id;
    }
