...
/**
 * NoMatchImmigrationsId generated by hbm2java
 */
@Embeddable
public class NoMatchImmigrationsId  implements java.io.Serializable {
    ...
    public NoMatchImmigrationsId() {}

    public NoMatchImmigrationsId(String immigrateDate, String edCardNo, Integer immigrateSeq, String port, Long serialNo) {
    ...
    public boolean equals(Object other) {
		...
		if ( !(other instanceof NoMatchImmigrationsId) ) return false;
		NoMatchImmigrationsId castOther = ( NoMatchImmigrationsId ) other; 
