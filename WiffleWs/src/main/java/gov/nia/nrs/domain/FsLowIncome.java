 ...
 */
@Entity
@Table(name = "FsLowIncome")
public class FsLowIncome implements java.io.Serializable {
	...
	public FsLowIncome(String personId, String deleteFlag, String createUserId,
	...
	public FsLowIncome(String personId, String header, String chineseName,
			String birthDate, String marry, String spouseName, String cityA,
			String townshipA, String addr1a, String addr2a, String addr3a,
			String addr4a, String specialCode, String gender,
			String createDeptId, String maintainDeptId, String deleteFlag,
