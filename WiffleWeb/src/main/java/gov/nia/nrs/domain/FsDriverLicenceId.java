...
public class FsDriverLicenceId implements java.io.Serializable {
	...
	public FsDriverLicenceId(String residentIdNo, String personId,
			String licenceType) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FsDriverLicenceId))
			return false;
		FsDriverLicenceId castOther = (FsDriverLicenceId) other;

		return ((this.getResidentIdNo() == castOther.getResidentIdNo()) || (this
				...
				&& ((this.getLicenceType() == castOther.getLicenceType()) || (this
						.getLicenceType() != null
						&& castOther.getLicenceType() != null && this
						.getLicenceType().equals(castOther.getLicenceType())));
	}
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLicenceType() == null ? 0 : this.getLicenceType()
						.hashCode());
		return result;
	}
