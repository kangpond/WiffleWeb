 ...
 * @author Tim
 */
@Namespace("/monthOfNation")
public class MonthOfNationAction extends MonthOfAction
{
	private static final long serialVersionUID = 8352155487683068486L;

	private static final Logger logger = Logger.getLogger(MonthOfNationAction.class);
	...
	@Action(value = "query", results = { @Result(name = SUCCESS, location = "monthOfNationQuery", type = "tiles") })
	...
	@Action(value = "list", results = { @Result(name = SUCCESS, location = "monthOfNationList", type = "tiles"),
			@Result(name = INPUT, location = "monthOfNationQuery", type = "tiles") })
	...
	{
		String fileName = getFileName("國籍每月分析表");
	...
	@Action(value = "report", results = {
			@Result(name = INPUT, location = "monthOfNationList", type = "tiles"),
