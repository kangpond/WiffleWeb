 ...
 * @author Tim
 */
@Namespace("/monthOfEdu")
public class MonthOfEduAction extends MonthOfAction
{
	private static final long serialVersionUID = -1870890425333576212L;

	private static final Logger logger = Logger.getLogger(MonthOfEduAction.class);
	...
	@Action(value = "query", results = { @Result(name = SUCCESS, location = "monthOfEduQuery", type = "tiles") })
	...
	@Action(value = "list", results = { @Result(name = SUCCESS, location = "monthOfEduList", type = "tiles"),
			@Result(name = INPUT, location = "monthOfEduQuery", type = "tiles") })
	...
	public String getWhereFilter()
	{
		...
		whereFilter.append(" and CategoryType='2'");
	...
	@Action(value = "report", results = {
			@Result(name = INPUT, location = "monthOfEduList", type = "tiles"),
