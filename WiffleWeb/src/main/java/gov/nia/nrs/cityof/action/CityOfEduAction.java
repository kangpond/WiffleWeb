 ...
 */
@Namespace("/cityOfEdu")
public class CityOfEduAction extends CityOfAction
{
	private static final long serialVersionUID = -7730867850119755009L;

	private static final Logger logger = Logger.getLogger(CityOfEduAction.class);
	...
	@Action(value = "query", results = { @Result(name = SUCCESS, location = "cityOfEduQuery", type = "tiles") })
	...
	@Action(value = "list", results = { @Result(name = SUCCESS, location = "cityOfEduList", type = "tiles"),
			@Result(name = INPUT, location = "cityOfEduQuery", type = "tiles") })
	...
	@Action(value = "report", results = {
			@Result(name = INPUT, location = "cityOfEduList", type = "tiles"),
